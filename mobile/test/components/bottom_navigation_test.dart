...
void main() {
  group('WCBottomNavigation visual contract', () {
    testWidgets('renders five nav items with correct height and background',
        (tester) async {
      ...
      final material = tester.widget<Material>(find
          .descendant(of: navFinder, matching: find.byType(Material))
          .first);
      expect(material.color, WorldChefColors.brandBlue);

      // verify 5 items
      final iconFinders =
          find.descendant(of: navFinder, matching: find.byType(Icon));
