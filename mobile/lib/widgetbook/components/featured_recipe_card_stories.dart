        ...
        WidgetbookUseCase(
          ...
          builder: (context) {
            ...
            final titles = {
              ...
              'Long': 'Authentic Italian Truffle and Wild Mushroom Risotto with Parmesan',
            };
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: WCFeaturedRecipeCard(
                      ...
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Tapped: ${titles[titleLength]}')),
                        );
                      },
                    ),
                  ),
        ...
        WidgetbookUseCase(
          ...
          builder: (context) {
            final errorType = context.knobs.list(
              label: 'Error Type',
              options: ['No Avatar', 'Zero Rating', 'Long Creator Name', 'Invalid Image'],
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: WCFeaturedRecipeCard(
                      ...
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Error case tapped: $errorType')),
                        );
                      },
                    ),
                  ),
...
class _InteractiveRecipeCardDemo extends StatefulWidget {
  @override
  _InteractiveRecipeCardDemoState createState() => _InteractiveRecipeCardDemoState();
}

class _InteractiveRecipeCardDemoState extends State<_InteractiveRecipeCardDemo> {
  int tapCount = 0;
  ...
  final List<RecipeCardData> recipes = [
    ...
    RecipeCardData(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1555507036-ab794f4d4d94?w=400',
      creator: CreatorData(
        name: 'Chef Pierre',
          ...
          ...recipes.map((recipe) => Container(
            ...
            child: WCFeaturedRecipeCard(
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Tapped: ${recipe.title} (Total: $tapCount)'),
