...
class WorldChefTextStyles {
  ...
  static final TextStyle displayLarge = GoogleFonts.lora(
    fontSize: 32,
    fontWeight: FontWeight.w700,
    height: 1.4,
  );
  
  static final TextStyle displayMedium = GoogleFonts.lora(
    fontSize: 28,
    fontWeight: FontWeight.w700,
    height: 1.4,
  );
  
  static final TextStyle displaySmall = GoogleFonts.lora(
    fontSize: 24,
    fontWeight: FontWeight.w700,
    height: 1.4,
  );
  ...
  static final TextStyle headlineLarge = GoogleFonts.lora(
    fontSize: 22,
    fontWeight: FontWeight.w700,
    height: 1.4,
  );
  
  static final TextStyle headlineMedium = GoogleFonts.lora(
    fontSize: 20,
    fontWeight: FontWeight.w700,
    height: 1.4,
  );
  
  static final TextStyle headlineSmall = GoogleFonts.lora(
    fontSize: 18,
    fontWeight: FontWeight.w700,
    height: 1.4,
  );
